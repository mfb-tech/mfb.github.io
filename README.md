...
<body>
  ...
  <script>
    const players = [
      ...
      { name: "Per Mertesacker", country: "Germany", position: "Defender", era: "2000s", club: "Arsenal" },
      { name: "Gheorghe Hagi", country: "Romania", position: "Midfielder", era: "1990s", club: "Real Madrid" },
      { name: "Emil Krafth", country: "Sweden", position: "Defender", era: "2010s-2020s", club: "Newcastle,Amiens(loan),Bologna,Helsinborgs IF,Osters IF,Lagans AIK" }
    ];
